...
app.use(express.static('./public/mean-library'));
app.use(cors());
...
app.get('/',(req,res)=>{
    //res.redirect('/login');
    res.sendFile(path.join(__dirname,'/public/mean-library/index.html'));
    // res.render("index",{
    //     title:"Library",
...
app.post('/createauthor',uploadImage.single('cover_img'),(req,res,next)=>{
...
app.post('/createbook',uploadImage.single('cover_img'),(req,res,next)=>{
